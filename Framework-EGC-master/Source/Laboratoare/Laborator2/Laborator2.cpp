...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 0.5f, 1), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(0.5f, 1, 0), glm::vec3(1, 0, 1)),
		...
		vector<VertexFormat> vertices_circle =
		{
			...
			VertexFormat(glm::vec3(0.866f, 0.5f, 0), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(0.7f, 0.7f, 0), glm::vec3(1, 0, 0)),
			VertexFormat(glm::vec3(0.5f, 0.866f, 0), glm::vec3(1, 0, 0)),
		...
		Mesh *tetra = CreateMesh("tetra", vertices, indices);
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["tetra"], shaders["VertexNormal"], glm::vec3(-1.5f, 0.5f, 0), glm::vec3(1));
	RenderMesh(meshes["square"], shaders["VertexColor"], glm::vec3(1.5f, 0.5f, 0.5f), glm::vec3(1));
